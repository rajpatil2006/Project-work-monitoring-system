...
<head>
    ...
    <title>Project Monitoring System - Admin Dashboard</title>
            ...
            <form method="POST">
                ...
                <div id="additionalFields" style="display: none;">
                    ...
                    <input type="text" id="field1" name="sname" placeholder="no"
                        value="<?php echo $row['sponsershipname']; ?>" >
                    <label for="field2">Sponsorship Details:</label>
                    <textarea id="field2" name="sdetails" ><?php echo $row['sponsershipdetail']; ?></textarea>
                </div>
...
if(isset($_POST['submit'])) {
    ...
    // Check if sponsorship is selected and if it's "yes"
    if(isset($sponsorship) && $sponsorship === 'yes') {
        // If sponsorship is "yes", check if both sponsorship name and details are 'no'
        if($sname === '' && $sdetails === '') {
            echo "<script>";
        ...
        // If sponsorship is not selected or if it's "no", update project details only
        $updateQuery = "UPDATE grouptable SET projecttitle='$projectt', projectdetail='$detailss',sponsershipname='', sponsershipdetail='' WHERE id='$g_id'";
    }
