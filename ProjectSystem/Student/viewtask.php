...
<head>
    ...
    <title>view task- Student Dashboard</title>
...
<body>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <?php if($Trow['file_name'] == 'no'){
            ...
            ?><br>View your file: <a href='taskpdfs/<?php echo $Trow["file_name"]; ?>' target='_blank'>View pdf</a><br><br><?php
        }
        ?>
