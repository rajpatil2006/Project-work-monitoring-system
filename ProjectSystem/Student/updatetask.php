...
<head>
    ...
    <title>Update task- Student Dashboard</title>
...
<body>
    ...
    <form method="POST" enctype="multipart/form-data">
        <br>
         <i style="background-color:yellow">Changes/Suggestion from mentor:</i><br> 
        ...
        <textarea id="activitiesPlanned" name="solution" required><?php echo $Trow['solution']; ?></textarea>
        ...
        <?php if($Trow['file_name'] == 'no'){
            ...
            ?><br>View your existing submitted file: <a href='taskpdfs/<?php echo $Trow["file_name"]; ?>' target='_blank'>View pdf</a><br><?php
        }
        ?>
         <label for="solution">New Attachment:</label>
         <input type="file" name="pdf_file" accept=".pdf"><br><br>
         <span>-Your old pdf will replace with new one if you add new attachment..</span>
        ...
        <input type="submit" name="update" value="Update" style="margin-top:30px">
    </form>
        </div> 
    </div>
</body>
...
if(isset($_POST['update'])) {
    ...
    if ($update) {
        echo "<script>";
        echo "window.alert('Task Update successfully....!');";
        echo "window.location.href = 'taskmanage.php?studentId=$studentId&year=$year&groupNo=$groupNo&weekId=$weekId&wId=$wId';";
        echo "</script>";
    } else {
        echo "<script>";
