...
<head>
    ...
    <title>Update weekly diary - Student Dashboard</title>
...
<body>
    ...
    <form method="POST">
    <label for="">Changes/Suggestion from mentor:<i style="color:red">*</i></label>
        <p style="padding-left:20px;padding-top:1px;">-<?php echo $week['suggestion'];?></p>
        <br>
