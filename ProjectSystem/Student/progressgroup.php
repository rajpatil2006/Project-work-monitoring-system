...
<body>
    <header>
         <h2>Welcome <?php
               $selectQuery = "SELECT * FROM `student` WHERE id = $studentId ";
                ...
                echo $rowM['firstname'].' '.$rowM['lastname']?> - Progress </h2>
    </header>
    ...
    <div id="container">
        ...
        <?php
        if(isset($_GET['fsem'])) {?>
            <b><a href="progressgroup.php<?php echo '?year='.$year.'&studentId='.$studentId.'&groupNo='.$groupNo ?>" style="font-size: 18px;color:black;">Semester 5
                    | </a>
                <a href="progressgroup.php<?php echo '?year='.$year.'&fsem=6&studentId='.$studentId.'&groupNo='.$groupNo ?>" style="font-size: 15px;color:blue">Semester
                    6</a></b>
            <?php }
        else{?>
            <b><a href="progressgroup.php<?php echo '?year='.$year.'&studentId='.$studentId.'&groupNo='.$groupNo ?>" style="font-size: 18px;color:blue;">Semester 5
                    | </a>
                <a href="progressgroup.php<?php echo '?year='.$year.'&fsem=6&studentId='.$studentId.'&groupNo='.$groupNo ?>" style="font-size: 15px;color:black">Semester
                    6</a></b>
            ...
            <table>
                ...
                if(isset($_GET['mname'])) {
                    ...
                    $selectGroupQuery = "SELECT * FROM `grouptable` where year=$year AND groupno=$groupNo ORDER BY groupno ASC";
                    $GroupQuery = mysqli_query($con, $selectGroupQuery);
                }
