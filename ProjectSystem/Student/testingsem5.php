...
$ye=$year;
$selectQuery = "SELECT * FROM `timeline` where $ye=$year AND semester=5 ORDER BY weeknumber ASC";
$Result = mysqli_query($con, $selectQuery);

// instantiate and use the dompdf class
$dompdf = new Dompdf();
ob_start();
require('test_details5.php');
...
$dompdf->stream('print-details5.pdf',['Attachment'=>false]);
?>