...
<body>
    ...
    <header >
        <h2>Welcome <?php
               $selectQuery = "SELECT * FROM `student` WHERE id = $studentId ";
                ...
                echo $rowM['firstname'].' '.$rowM['lastname']?> -  Task Submission</h2>
    </header>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <textarea id="activitiesPlanned" name="solution" required></textarea>
        <label for="solution">Attachment (if any):</label>
...
<?php
  ...
  if(isset($_POST['submit']))
  {
	...
	if ($update) {
		echo "<script>;";
		echo "window.alert('Task submitted successfully....!');";
